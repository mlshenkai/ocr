...
class TextRecognizer(BaseOCR):
    def __init__(self, args, **kwargs):
        ...
        weights = self.read_weights(self.weights_path)
...
if __name__=="__main__":
    ...
    args.rec_model_path="../../resources/models/rec/ch_ptocr_server_v2.0_rec_infer.pth"
    args.vis_font_path="../../doc/fonts/simfang.ttf"
    args.rec_char_dict_path="../../ocr/utils/dict/ch_keys.txt"
    args.use_space_char=True
    text_recognizer=TextRecognizer(args)
    valid_image_file_list=[]
    img_list=[]
    image_file_list = get_image_file_list("../../data/s111.jpg")
    ...
    rec_res, predict_time = text_recognizer.predict(img_list)
    print(rec_res,predict_time)
